...
Author: Yousha Mehdi(22K-6007), Muhammad Yasir(22K-5090), Ghazi Abbass(22K-5041)
    ...
    <div class="glass-card" style="text-align: center; margin-bottom: 2.5rem; padding: 3rem 2rem;">
        ...
        <div style="display: flex; justify-content: center; gap: 1rem; flex-wrap: wrap; margin-top: 2rem;">
            <span class="info-badge" style="font-size: 1.05rem; padding: 0.8rem 1.8rem;">
                👥 <strong>Authors:</strong> Yousha Mehdi (22K-6007) • Muhammad Yasir (22K-5090) • Ghazi Abbass (22K-5041)
            </span>
            <span class="info-badge" style="font-size: 1.05rem; padding: 0.8rem 1.8rem;">
